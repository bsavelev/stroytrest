...
MEDIA_ROOT = get_filepath(STATIC_FILES, 'media')
...
STATIC_ROOT = get_filepath(STATIC_FILES, 'static_root')
...
static_dir1 = get_filepath(STATIC_FILES, 'static')
STATICFILES_DIRS = (
...
SECRET_KEY = 'gintuisb*(wh4=1)a)f=b&6asd80m775uk=j4t+77rne*%&63i'
...
tempate_dir1 = get_filepath(PROJECT_DIR, 'templates')
TEMPLATE_DIRS = (
